...
set_cbat <- function(task_name = "task_name",
  ...
  if(jsPsych_version=="6.3.1"||jsPsych_version=="7.1.1"||
     ...
     jsPsych_version=="8.0.0"||jsPsych_version=="8.0.1"){
  }else{
  ...
  if(jsPsych_version == "6.3.1"){
    ...
    file_path <- paste0(path,"/",task_name)
    download.file(paste0("https://raw.githubusercontent.com/ykunisato/template-jsPsych-task/main/template-jsPsych",substr(jsPsych_version, 1, 3),"/name_of_repository/task.js"),paste0(init_run_path,"/task.js"))
